...
class SeedAllTables extends Seeder
{
    public function run()
    {
        ...
        $fr->states()->createMany([
            ...
            ['code' => 'D', 'name' => 'Basse-Normandie'],
            ['code' => 'E', 'name' => 'Bourgogne'],
            ['code' => 'F', 'name' => 'Bretagne'],
            ['code' => 'G', 'name' => 'Centre – Val de Loire'],
            ['code' => 'H', 'name' => 'Champagne-Ardenne'],
            ['code' => 'I', 'name' => 'Corse'],
            ['code' => 'J', 'name' => 'Franche-Comté'],
            ['code' => 'K', 'name' => 'Haute-Normandie'],
            ['code' => 'L', 'name' => 'Île-de-France'],
            ['code' => 'M', 'name' => 'Languedoc-Roussillon'],
            ['code' => 'N', 'name' => 'Limousin'],
            ['code' => 'O', 'name' => 'Lorraine'],
            ['code' => 'P', 'name' => 'Midi-Pyrénées'],
            ['code' => 'Q', 'name' => 'Nord-Pas-de-Calais'],
            ['code' => 'R', 'name' => 'Pays de la Loire'],
            ['code' => 'S', 'name' => 'Picardie'],
